...
wget https://github.com/sdmanson8/scripts/blob/main/Script%20Files/rclone.service -o /etc/systemd/system/rclone.service
sleep 1s
...
wget https://github.com/sdmanson8/scripts/blob/main/Script%20Files/rclone-upload.sh -o ~/scripts/rclone-upload.sh
sleep 1s
