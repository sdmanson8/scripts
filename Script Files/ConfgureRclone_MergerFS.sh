...
sudo wget https://github.com/sdmanson8/scripts/blob/main/Script%20Files/rclone.service -O /etc/systemd/system/rclone.service
sleep 1s

# Download MergerFS Systemd File
printf '\nDownloading MergerFS Systemd File.. Please Wait\n\n'
sudo wget https://github.com/sdmanson8/scripts/blob/main/Script%20Files/mergerfs.service -O /etc/systemd/system/mergerfs.service
sleep 1s
...
sudo wget https://github.com/sdmanson8/scripts/blob/main/Script%20Files/rclone-upload.sh -O ~/scripts/rclone-upload.sh
sleep 1s
