...
#Mainmenu function. Contains the screen output for the menu and waits for and handles user input.  
 ...
 echo "    6. Optimizor, Hardening and Bloatware Removal Script for Windows 10 x64"
 echo "    7. New User Script Windows 10 x64"
 echo "    8. Optimizor, Hardening and Bloatware Removal Script for Windows 11 x64"
 echo "    9. New User Script Windows 11 x64"
 ...
 if ($answer -eq 11){
    ...
    $ScriptFromGithHub = Invoke-WebRequest https://raw.githubusercontent.com/sdmanson8/scripts/main/Script%20Files/WindowsOld.ps1 -UseBasicParsing
    Invoke-Expression $($ScriptFromGithHub.Content)  
 }  
 if ($answer -eq 12){
    Clear-Host
