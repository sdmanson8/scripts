...
#Create A Restore Point
	...
	Checkpoint-Computer -Description "New User Windows 11 Optimizer" -RestorePointType MODIFY_SETTINGS
...
regedit.exe /S "$downloads\PreventBloatwareReInstall.reg" -ErrorAction SilentlyContinue -Confirm:$false -Force
